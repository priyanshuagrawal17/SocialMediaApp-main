          ...
          >
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <span className="font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent hover:text-indigo-600 transition-all duration-500">Priyanshu</span>
              </div>
            ...
            <div className="flex items-center space-x-1 md:space-x-3">
              ...
              <a
                href={"https://github.com/priyanshuNRY/SocialMediaApp/fork"}
                target='_blank'
